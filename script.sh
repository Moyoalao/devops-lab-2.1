...
echo Mayoalao >> README.md
echo "[devops-lab-2](https://github.com/Moyoalao/devops-lab-2.1.git)" >> README.md
echo --- >> README.md
...
git remote add origin https://github.com/Moyoalao/devops-lab-2.1.git
git branch -M main
